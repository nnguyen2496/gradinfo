#' @title gradinfo: access and analyze data about Williams College graduating classes
#'
#' @description gradinfo reads in information about graduating classes of Williams College from 2001 to 2016 and
